        ...
        <Flex justifyContent="space-around" my={10} flexWrap="wrap" gap={5}>
            ...
            >
                <Image
                    ...
                    src={
                        sexSelected === "masculine"
                            ? "/imgModalHome/iconeiniciomasc_frete.svg"
                            : "/imgModalHome/iconeiniciofem_frete.svg"
                    }
                    alt="Frete"
                    _hover={{
            ...
            >
                <Image
                    ...
                    src={
                        sexSelected === "masculine"
                            ? "/imgModalHome/iconeiniciomasc_suporte.svg"
                            : "/imgModalHome/iconeiniciofem_suporte.svg"
                    }
                    alt="suporte"
                    _hover={{
                        boxShadow: "0px 0px 38px 5px rgba(70, 62, 221, 0.1)",
            ...
            >
                <Image
                    ...
                    src={
                        sexSelected === "masculine"
                            ? "/imgModalHome/iconeiniciomasc_revendedor.svg"
                            : "/imgModalHome/iconeiniciofem_revendedor.svg"
                    }
                    alt="revendedor"
                    _hover={{
                        boxShadow: "0px 0px 38px 5px rgba(70, 62, 221, 0.1)",
            ...
            >
                <Image
                    ...
                    src={
                        sexSelected === "masculine"
                            ? "/imgModalHome/iconeiniciomasc_parcele.svg"
                            : "/imgModalHome/iconeiniciofem_parcele.svg"
                    }
                    alt="parcele"
                    _hover={{
                        boxShadow: "0px 0px 38px 5px rgba(70, 62, 221, 0.1)",
